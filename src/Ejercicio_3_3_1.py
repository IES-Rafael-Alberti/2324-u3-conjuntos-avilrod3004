...
def domicilios_clientes(compras_clientes: list):
    '''
    '''
    domicilios = []
    for i in range(0, len(compras_clientes)):
        domicilios.append(compras_clientes[i][3])
        i += 1
...
def main():
    # ENTARDA
    compras_clientes = [("Nuria Costa", 5, 12780.78, "Calle Las Flores 355"), ("Jorge Russo", 7, 699, "Mirasol 218"), ("Nuria Costa", 7, 532.90, "Calle Las Flores 355"), ("Julián Rodriguez", 12, 5715.99, "La Mancha 761"), ("Jorge Russo", 15, 958, "Mirasol 218")]

    #PROCESO
    domicilios = domicilios_clientes(compras_clientes)

    # SALIDA
    for i in domicilios:
        print(f'Enviar factura de compra al domicilio => {i}')
